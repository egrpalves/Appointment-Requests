...
const NutritionistSelector = ({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-card p-4 mb-6 flex flex-wrap flex-col sm:flex-row sm:items-center gap-3">
      ...
      <div className="flex gap-1 bg-slate-100 p-1 rounded-lg">
        {FILTERS.map((f) => (
          <button
            ...
            className={`w-full px-3 py-1.5 rounded-lg text-xs font-semibold capitalize transition-colors cursor-pointer ${
              statusFilter === f
