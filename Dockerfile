...
# docker build -t appointment_requests .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name appointment_requests appointment_requests
